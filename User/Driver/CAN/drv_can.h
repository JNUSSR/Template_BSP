...
/* 兼容性 typedef，使得在 C/C++ 及其他翻译单元中直接使用类型名而无需写 `struct` */
typedef struct Struct_CAN_Rx_Buffer Struct_CAN_Rx_Buffer;
...
typedef struct Struct_CAN_Manage_Object Struct_CAN_Manage_Object;
